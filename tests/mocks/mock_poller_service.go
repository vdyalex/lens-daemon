...
//
//	mockgen -destination tests/mocks/mock_poller_service.go -package mocks -mock_names Service=MockPollerService github.com/vdyalex/lens-daemon/src/adapters/im/poller Service
//
